...
- **Biometric** - защита с помощью отпечатка пальца
- **Android KeyStore** - защищенное хранилище ключей с аппаратной поддержкой
...
- ✅ Шифрование блокнотов с помощью Android KeyStore
- ✅ Биометрическая аутентификация через отпечаток пальца
- ✅ Автоматическая блокировка при выходе из блокнота
- ✅ Расшифровка заметок на лету при доступе
- ✅ Кнопка для пролистывания текста до конца заметки при редактировании
